...
> "There is a dimension, beyond that which is known to man. It is a dimension as vast as space and as timeless as infinity" - Twilight Zone

I joined Scratchpad in an effort to expand beyond my software safe space and get into harder engineering disciplines. My first stop in that journey has been 3D printing. I purchased my first printer ever, a [Bambu Lab][bambu-lab] P1S. If you've got the spare cash, it's a wonderful machine to start with. Bambu Lab in general has a very robust ecosystem and is very beginner friendly.
